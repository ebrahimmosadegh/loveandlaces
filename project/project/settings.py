...
ALLOWED_HOSTS = ['127.0.0.1','194.164.91.223','loveandlaces.co.uk','www.loveandlaces.co.uk']
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'tools.templatetags.template_tags.settings',
            ],
        },
    },
]
...
STATIC_ROOT = os.path.join(BASE_DIR, 'site_statics')
